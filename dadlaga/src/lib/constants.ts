export const RAMP = ['#e8f0ff','#cfe0ff','#b7d0ff','#9fc0ff','#86afff','#6f9fff','#5186ff'];

export const QUAL = ['#8dd3c7','#ffffb3','#bebada','#fb8072','#80b1d3','#fdb462','#b3de69','#fccde5','#d9d9d9','#bc80bd','#ccebc5','#ffed6f'];
